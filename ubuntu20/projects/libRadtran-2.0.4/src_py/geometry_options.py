    ...
    def __init__(self):
        ...
        mc_satellite_view = option(
            ...
            tokens=[addSetting(name='Input.rte.mc.pan_angles', setting='calloc (4, sizeof(double))'),
                ...
                addSetting(name='Input.rte.mc.allocate_umu_and_phi', setting=True) ],
            parents=['mc_backward'],
            non_parents=['mc_panorama_view','mc_panorama_file'],
            speaker='rte_solver',
            enable_values=("mystic","montecarlo"),
            threedmystic =True,
            islidar=False,
        ...
        mc_panorama_forward = option(
            ...
            tokens=[addSetting(name='Input.rte.mc.pan_angles', setting='calloc (4, sizeof(double))'),
                ...
                addSetting(name='Input.rte.mc.pan_angles[1]', setting=360.0),
                addSetting(name='Input.rte.mc.pan_angles[2]', setting=0.0),
                addSetting(name='Input.rte.mc.pan_angles[3]', setting=180.0),
                addSetting(name='Input.rte.mc.panorama_forward', setting=1),
                addSetting(name='Input.rte.mc.allocate_umu_and_phi', setting=True) ],
