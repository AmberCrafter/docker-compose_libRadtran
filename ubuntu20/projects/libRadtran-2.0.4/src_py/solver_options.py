...
#no_sdisort     )
        ...
        twomaxrnd3C_scale_cf = option(
            ...
            tokens=addToken(name='Input.rte.twomaxrnd3C_scale_cf', datatype=float, default=1.0),
            parents=['rte_solver'],
            speaker='rte_solver',
            enable_values=("twomaxrnd3C",),
        )
        dynamic_twostream_iterations = option(
            name='dynamic_twostream_iterations',
            group='solver',
            helpstr='Number of iterations for dynamic twostream',
            documentation=documentation['dynamic_twostream_iterations'],
            tokens=addToken(name='Input.rte.dynamic_iterations', datatype=int, default=1),
            parents=['rte_solver'],
            speaker='rte_solver',
            enable_values=("dynamic_twostream",),
            developer=True,
        )
        dynamic_tenstream_iterations = option(
            name='dynamic_tenstream_iterations',
            group='solver',
            helpstr='Number of iterations for dynamic tenstream',
            documentation=documentation['dynamic_tenstream_iterations'],
            tokens=addToken(name='Input.rte.dynamic_iterations', datatype=int, default=1),
            parents=['rte_solver'],
            speaker='rte_solver',
            enable_values=("dynamic_tenstream",),
            developer=True,
        )
        mc_nca = option(
            name='mc_nca',
...
def get_solver_documentation():
    ...
    \undocumented{
     \parameter{dynamic_tenstream}
     Dynamic tenstream code. \code{zout_interpolate} is activated automatically.
    }

    \undocumented{
     \parameter{dynamic_tenstream_iterations}
    Number of iterations for dynamic tenstream. Default: 1.
    }

    \undocumented{
     \parameter{dynamic_twostream}
     Dynamic twostream code. \code{zout_interpolate} is activated automatically.
    }

    \undocumented{
     \parameter{dynamic_twostream_iterations}
    Number of iterations for dynamic twostream. Default: 1.
    }
    ...
    Scale factor for cloud fraction split for radiative transfer solver \code{twomaxrnc3C}.
        ''',
        'dynamic_twostream_iterations' : r'''
    Number of iterations for radiative transfer solver \code{dynamic_twostream}.
        ''',
        'dynamic_tenstream_iterations' : r'''
    Number of iterations for radiative transfer solver \code{dynamic_tenstream}.
        ''',
        'mc_nca' : r'''
