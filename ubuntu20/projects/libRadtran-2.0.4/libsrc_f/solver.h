...
/* prototypes */
void F77_FUNC (disort, DISORT) (int*        nlyr,
                                float*      dtauc,
                                float*      ssalb,
                                float*      pmom,
                                float*      temper,
...
void F77_FUNC (disort2, DISORT2) (int*        nlyr,
                                  float*      dtauc,
                                  float*      ssalb,
                                  int*        nmom,
                                  float*      pmom,
...
void F77_FUNC (polradtran, POLRADTRAN) (int*         nstokes,
                                        int*         nummu,
                                        int*         aziorder,
...
void F77_FUNC (radtran, RADTRAN) (int*         nstokes,
                                  int*         nummu,
                                  int*         aziorder,
                                  double*      max_delta_tau,
                                  int*         src_code,
...
void F77_FUNC (sdisort, SDISORT) (int*        nlyr,
                                  float*      dtauc,
                                  float*      ssalb,
                                  float*      pmom,
                                  float*      temper,
...
void F77_FUNC (spsdisort, SPSDISORT) (int*        nlyr,
                                      float*      dtauc,
                                      float*      ssalb,
                                      float*      pmom,
                                      float*      temper,
...
void F77_FUNC (twostr, TWOSTR) (float*      albedo,
                                float*      btemp,
                                int*        deltam,
                                float*      dtauc,
                                float*      fbeam,
...
void F77_FUNC (tzs, TZS) (int*        nlyr,
                          float*      dtauc,
                          float*      ssalb,
                          float*      temper,
                          float*      wvnmlo,
...
void F77_FUNC (sss, SSS) (int*        nlyr,
                          float*      dtauc,
                          float*      ssalb,
                          int*        nmom,
                          float*      pmom,
...
void F77_FUNC (sssi, SSSI) (int*        nlyr,
                            float*      dtauc,
                            float*      ssalb,
                            int*        nmom,
                            float*      pmom,
...
void F77_FUNC (setout, SETOUT) (float* dtauc, int* nlyr, int* ntau, float* utau, float* z, float* zout);
void F77_FUNC (setoutd, SETOUTD) (float* dtauc, int* nlyr, int* ntau, float* utau, float* z, float* zout);
