...
int scale_output (input_struct                 input,
                  ...
                  float*****                   p_abs3d_var,
                  float*****                   p_absback3d_var, /* **CK added float *****p_abs3d_var for forward mc_std */
                  int                          nzout,
                  int                          Nx,
                  int                          Ny,
                  int                          Nz,
...
int scale_output_triangle_surface (const double ffactor, t_triangle_radiation_field* srfc);
