...

{
  ...
  status += average_dens ((*p_T)[0][0], (*p_dens)[MOL_AIR][0][0], znew, nnew, interpol_method_temper, &((*p_Tavg)[0][0]), NO);
  ...
  if (*p_densavg != NULL) {
    for (i = 0; i < MOL_NN; i++) {
      ...
      status += average_dens ((*p_dens)[i][0][0],
                              (*p_dens)[MOL_AIR][0][0],
                              znew,
                              nnew,
                              interpol_method_gas[i],
