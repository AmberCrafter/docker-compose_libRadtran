...
int ASCII_checkfile_nrows (const char* filename, int nrows, int* rows, int* min_columns, int* max_columns, int* max_length)
...
int ASCII_checkfile (char* filename, int* rows, int* min_columns, int* max_columns, int* max_length)

{
  int status = 0;

  status = ASCII_checkfile_nrows (filename, -1, rows, min_columns, max_columns, max_length);
  return status;
}
...
int ASCII_free_char (char** value, int rows) {
  int i = 0;
...
int ASCII_calloc_int (int*** value, int rows, int columns) {
  ...
  for (i = 0; i < rows; i++)
    if (((*value)[i] = (int*)calloc ((size_t)columns, sizeof (int))) == NULL)
      return ASCII_NO_MEMORY;
...
int ASCII_calloc_double (double*** value, int rows, int columns) {
  ...
  if (rows > 0) {
    ...
    if (columns > 0)
      for (i = 0; i < rows; i++)
        if (((*value)[i] = (double*)calloc ((size_t)columns, sizeof (double))) == NULL)
          return ASCII_NO_MEMORY;
  }
...
int ASCII_calloc_double_5D_arylen (double****** value, int dim1, int dim2, int dim3, int dim4, int* dim5) {
  int i = 0, j = 0, k = 0, l = 0;
...
/***********************************************************************************/
/* Function: ASCII_calloc_float_5D_arylen_restricted                      @30_30i@ */
/* Description: Allocate memory for a five-dimensional array of float. Only        */
/*   a restricted range (marked by columns_lower and columns_upper) is actually    */
/*   allocated; the function is very special - maybe not of much general use.      */
/* Parameters:                                                                     */
/* Return value:                                                                   */
...
int ASCII_calloc_float_5D_arylen_restricted (float****** value,
                                             int         dim1,
                                             int         dim2,
                                             int         dim3,
                                             int         dim4,
  ...
  if ((*value = (float*****)calloc (dim1, sizeof (float****))) == NULL)
    return ASCII_NO_MEMORY;

  for (i = 0; i < dim1; i++) {
    if (((*value)[i] = (float****)calloc (dim2, sizeof (float***))) == NULL)
      return ASCII_NO_MEMORY;

    for (j = 0; j < dim2; j++) {
      if (((*value)[i][j] = (float***)calloc (dim3, sizeof (float**))) == NULL)
        return ASCII_NO_MEMORY;

      for (k = 0; k < dim3; k++) {
        if (((*value)[i][j][k] = (float**)calloc (dim4, sizeof (float*))) == NULL)
          return ASCII_NO_MEMORY;

        for (l = dim4_lower; l <= dim4_upper; l++)
          if (dim5[l] > 0) /* need to check because some OSs don't like calloc (0) */
            if (((*value)[i][j][k][l] = (float*)calloc (dim5[l], sizeof (float))) == NULL)
              return ASCII_NO_MEMORY;
      }
    }
  }
...
int ASCII_calloc_float_5D (float****** value, int rows, int columns, int length, int fourth_dimension, int fifth_dimension) {
  int i = 0, j = 0, k = 0, l = 0;
...
/***********************************************************************************/
int ASCII_calloc_double_5D (double****** value, int rows, int columns, int length, int fourth_dimension, int fifth_dimension) {
  int i = 0, j = 0, k = 0, l = 0;
...
/***********************************************************************************/
/* Function: ASCII_calloc_float_7D                                        @30_30i@ */
/* Description: Allocate memory for a six-dimensional array of float.              */
/* Parameters:                                                                     */
/* Return value:                                                                   */
/*  0  if o.k., <0 if error                                                        */
...
/* Files:                                                                          */
/* Known bugs:                                                                     */
/* Author: Arve Kylling (extended to 7D by Claudia Emde)                  @i30_30@ */
/***********************************************************************************/
int ASCII_calloc_float_7D (float******** value,
                           int           rows,
                           int           columns,
                           int           length,
                           int           fourth_dimension,
        ...
        for (l = 0; l < fourth_dimension; l++) {
          ...
          for (m = 0; m < fifth_dimension; m++) {
            ...
            for (n = 0; n < sixth_dimension; n++) {
              if (((*value)[i][j][k][l][m][n] = (float*)calloc (seventh_dimension, sizeof (float))) == NULL)
                if (errno == ENOMEM)
                  return ASCII_NO_MEMORY;
            }
          }
...
/**********************************************************************************************/
/* Function: ASCII_free_float_5D_restricted                                          @30_30i@ */
/* Description: Free memory, which has been allocated with ASCII_calloc_float_5D_restricted.  */
/* Parameters:                                                                                */
/* Return value:                                                                              */
/*  0  if o.k., <0 if error                                                                   */
/*                                                                                            */
...
int ASCII_free_float_5D_restricted (float***** value,
                                    int        rows,
                                    int        columns,
                                    int        length,
                                    int        fourth_dimension,
...
int ASCII_free_double_5D (double***** value, int rows, int columns, int length, int fourth_dimension) {
  int i = 0, j = 0, k = 0, l = 0;
...
/**********************************************************************************************/
/* Function: ASCII_free_double_5D_restricted                                         @30_30i@ */
/* Description: Free memory, which has been allocated with ASCII_calloc_double_5D_restricted. */
/* Parameters:                                                                                */
/* Return value:                                                                              */
/*  0  if o.k., <0 if error                                                                   */
/*                                                                                            */
...
int ASCII_free_double_5D_restricted (double***** value,
                                     int         rows,
                                     int         columns,
                                     int         length,
                                     int         fourth_dimension,
...
int ASCII_readfile_nrows (const char* filename, int nrows, char*** array) {
  FILE* f                            = NULL;
  char  line[MAX_LENGTH_OF_LINE + 1] = "";
  char* string                       = NULL;
  char* t                            = NULL;
...
int ASCII_string2int (int** value, char*** string, int rows, int columns) {
  int i = 0, j = 0;
...
int ASCII_file2string (char* filename, int* rows, int* max_columns, int* min_columns, char**** string) {
  int status     = 0;
  int max_length = 0;
  ...
  if ((status = ASCII_calloc_string (string, *rows, *max_columns, max_length)) != 0)
    return status;
...
int ASCII_file2double_nrows (const char* filename, int nrows, int* rows, int* max_columns, int* min_columns, double*** value) {
  char*** string     = NULL;
  int     status     = 0;
  int     max_length = 0;

  /* count rows and columns of ASCII file <filename> */
  if ((status = ASCII_checkfile_nrows (filename, nrows, rows, min_columns, max_columns, &max_length)) != 0)
    return status;
...
int ASCII_file2double (const char* filename, int* rows, int* max_columns, int* min_columns, double*** value) {
  int status = 0;

  status = ASCII_file2double_nrows (filename, -1, rows, max_columns, min_columns, value);
...
int ASCII_file2int (char* filename, int* rows, int* max_columns, int* min_columns, int*** value) {
  char*** string     = NULL;
  int     status     = 0;
  int     max_length = 0;
...
int ASCII_file2float (char* filename, int* rows, int* max_columns, int* min_columns, float*** value) {
  char*** string     = NULL;
  int     status     = 0;
  int     max_length = 0;
...
int read_1c_file (char* filename, double** first, int* n) {
  ...
  /* read file */
  if ((status = ASCII_file2double (filename, n, &max_columns, &min_columns, &data)) != 0)
    return status;
...
int read_1c_file_float (char* filename, float** first, int* n) {
  ...
  /* read file */
  if ((status = ASCII_file2float (filename, n, &max_columns, &min_columns, &data)) != 0)
    return status;
...
int read_2c_file (char* filename, double** first, double** second, int* n) {
  int      max_columns = 0, min_columns = 0;
  double** data   = NULL;
  int      status = 0;
...
int read_2c_file_float (char* filename, float** first, float** second, int* n) {
  int     max_columns = 0, min_columns = 0;
  float** data   = NULL;
  int     status = 0;
...
int read_3c_file (char* filename, double** first, double** second, double** third, int* n) {
  int      max_columns = 0, min_columns = 0;
  double** data   = NULL;
  int      status = 0;
...
int read_3c_file_float (char* filename, float** first, float** second, float** third, int* n) {
  int     max_columns = 0, min_columns = 0;
  float** data   = NULL;
  int     status = 0;
...
int read_4c_file (char* filename, double** first, double** second, double** third, double** fourth, int* n) {
  int      max_columns = 0, min_columns = 0;
  double** data   = NULL;
  int      status = 0;
...
int read_4c_file_float (char* filename, float** first, float** second, float** third, float** fourth, int* n) {
  int     max_columns = 0, min_columns = 0;
  float** data   = NULL;
  int     status = 0;
...
int read_5c_file (char* filename, double** first, double** second, double** third, double** fourth, double** fifth, int* n) {
  int      max_columns = 0, min_columns = 0;
  double** data   = NULL;
  int      status = 0;
...
int read_5c_file_float (char* filename, float** first, float** second, float** third, float** fourth, float** fifth, int* n) {
  int     max_columns = 0, min_columns = 0;
  float** data   = NULL;
  int     status = 0;
...
int read_2r_file (char* filename, int* rows, int* max_columns, int* min_columns, double*** value) {
  char*** string     = NULL;
  int     status     = 0;
  int     max_length = 0;
