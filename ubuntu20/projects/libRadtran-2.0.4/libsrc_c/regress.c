...
double weight_regression (double* x, double* y, double* sigma, int n, double* a, double* b, double* sigma_a, double* sigma_b) {
  int    i       = 0;
  double delta_x = 0, delta_y = 0;
...
int hyperbolafit (double* x, double* y, long number, double* a, double* b) {
  ...
  weight_regression (x_trans, y_trans, sigma, counter, a, b, &sigma_a, &sigma_b);
