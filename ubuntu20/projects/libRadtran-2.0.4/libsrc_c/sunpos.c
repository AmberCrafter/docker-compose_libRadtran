...
/* Changed from c++ to c by Arve Kylling, 17.10.2003.                            */

/* For all equations etc. see following paper:                         */
/*                                                                     */
...
void sunpos (struct cTime udtTime, struct cLocation udtLocation, struct cSunCoordinates* udtSunCoordinates) {
  ...
  dEclipticLongitude =
    dMeanLongitude + 0.03341607 * sin (dMeanAnomaly) + 0.00034894 * sin (2 * dMeanAnomaly) - 0.0001134 - 0.0000203 * sin (dOmega);
