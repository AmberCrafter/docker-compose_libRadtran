...
void GetOverlap (float, float, float, float, float, float, float, float*, float*);

/******************************************************************************************/
/* AMBRALS - Algorithm for MODIS Bidirectional Reflectance Anisotropy of the Land Surface */
/******************************************************************************************/

double ambrals_brdf (double iso, double vol, double geo, double mu1, double mu2, double phi) {
...
void F77_FUNC (ambralsfort, AMBRALSFORT) (float* iso, float* vol, float* geo, float* mu1, float* mu2, float* phi, float* bdref) {
