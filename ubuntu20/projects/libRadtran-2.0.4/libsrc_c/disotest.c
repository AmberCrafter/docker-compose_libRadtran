...
void disort_test01 (void) {
  ...
  register int  icas;
  extern void   c_disort(), c_errmsg(), c_getmom();
  ...
  for (icas = 1; icas <= ncase; icas++) {
    ...
    case 1:
      ...
      GOODUU (1, 1, 1) = 0., GOODUU (2, 1, 1) = 0., GOODUU (3, 1, 1) = 0., GOODUU (4, 1, 1) = 1.17771E-01,
                    GOODUU (5, 1, 1) = 2.64170E-02, GOODUU (6, 1, 1) = 1.34041E-02, GOODUU (1, 2, 1) = 1.33826E-02,
                    GOODUU (2, 2, 1) = 2.63324E-02, GOODUU (3, 2, 1) = 1.15898E-01, GOODUU (4, 2, 1) = 0., GOODUU (5, 2, 1) = 0.,
                    GOODUU (6, 2, 1) = 0.;
      break;
    case 2:
      UTAU (2)  = .03125;
      ...
      GOODUU (1, 1, 1) = 0., GOODUU (2, 1, 1) = 0., GOODUU (3, 1, 1) = 0., GOODUU (4, 1, 1) = 6.22884E-01,
                    GOODUU (5, 1, 1) = 1.39763E-01, GOODUU (6, 1, 1) = 7.09192E-02, GOODUU (1, 2, 1) = 7.08109E-02,
                    GOODUU (2, 2, 1) = 1.39337E-01, GOODUU (3, 2, 1) = 6.13458E-01, GOODUU (4, 2, 1) = 0., GOODUU (5, 2, 1) = 0.,
                    GOODUU (6, 2, 1) = 0.;
      break;
    case 3:
      UTAU (2)  = .03125;
      ...
      GOODUU (1, 1, 1) = 1., GOODUU (2, 1, 1) = 1., GOODUU (3, 1, 1) = 1., GOODUU (4, 1, 1) = 1.33177E-01,
                    GOODUU (5, 1, 1) = 2.99879E-02, GOODUU (6, 1, 1) = 1.52233E-02, GOODUU (1, 2, 1) = 9.84447E-01,
                    GOODUU (2, 2, 1) = 9.69363E-01, GOODUU (3, 2, 1) = 8.63946E-01, GOODUU (4, 2, 1) = 0., GOODUU (5, 2, 1) = 0.,
                    GOODUU (6, 2, 1) = 0.;
      break;
    case 4:
      UTAU (2)  = 32.;
      ...
      GOODUU (1, 1, 1) = 0., GOODUU (2, 1, 1) = 0., GOODUU (3, 1, 1) = 0., GOODUU (4, 1, 1) = 2.62972E-01,
                    GOODUU (5, 1, 1) = 9.06967E-02, GOODUU (6, 1, 1) = 5.02853E-02, GOODUU (1, 2, 1) = 1.22980E-15,
                    GOODUU (2, 2, 1) = 1.30698E-17, GOODUU (3, 2, 1) = 6.88840E-18, GOODUU (4, 2, 1) = 0., GOODUU (5, 2, 1) = 0.,
                    GOODUU (6, 2, 1) = 0.;
      break;
    case 5:
      UTAU (2)  = 32.;
      ...
      good.rad[0].dfdt = 0., good.rad[1].dfdt = 0.;
      GOODUU (1, 1, 1) = 0., GOODUU (2, 1, 1) = 0., GOODUU (3, 1, 1) = 0., GOODUU (4, 1, 1) = 1.93321E+00,
                    GOODUU (5, 1, 1) = 1.02732E+00, GOODUU (6, 1, 1) = 7.97199E-01, GOODUU (1, 2, 1) = 2.71316E-02,
                    GOODUU (2, 2, 1) = 1.87805E-02, GOODUU (3, 2, 1) = 1.16385E-02, GOODUU (4, 2, 1) = 0., GOODUU (5, 2, 1) = 0.,
                    GOODUU (6, 2, 1) = 0.;
      break;
    case 6:
      UTAU (2)  = 32.;
      ...
      GOODUU (1, 1, 1) = 1., GOODUU (2, 1, 1) = 1., GOODUU (3, 1, 1) = 1., GOODUU (4, 1, 1) = 8.77510E-01,
                    GOODUU (5, 1, 1) = 8.15136E-01, GOODUU (6, 1, 1) = 7.52715E-01, GOODUU (1, 2, 1) = 1.86840E-03,
                    GOODUU (2, 2, 1) = 1.26492E-03, GOODUU (3, 2, 1) = 7.79280E-04, GOODUU (4, 2, 1) = 0., GOODUU (5, 2, 1) = 0.,
                    GOODUU (6, 2, 1) = 0.;
      break;
    }
    ...
    sprintf (ds.header,
             "Test Case No. 1%.1s:  Isotropic Scattering, Ref. VH1, Table 12:  b =%9.5f, a =%5.2f",
             abc + icas - 1,
             UTAU (2),
             SSALB (1));
  ...
  for (iod = 1; iod <= 2; iod++) {
    ...
    for (iss = 1; iss <= 2; iss++) {
      ...
      case 1:
        ...
        GOODUU (1, 1, 1) = 0., GOODUU (2, 1, 1) = 0., GOODUU (3, 1, 1) = 0., GOODUU (4, 1, 1) = 1.61796E-01,
                      GOODUU (5, 1, 1) = 2.11501E-02, GOODUU (6, 1, 1) = 7.86713E-03, GOODUU (1, 2, 1) = 7.71897E-03,
                      GOODUU (2, 2, 1) = 2.00778E-02, GOODUU (3, 2, 1) = 2.57685E-02, GOODUU (4, 2, 1) = 0., GOODUU (5, 2, 1) = 0.,
                      GOODUU (6, 2, 1) = 0.;
        break;
      case 2:
        /* Correct answers */
        ...
        good.rad[0].dfdt = 0., good.rad[1].dfdt = 0.;
        GOODUU (1, 1, 1) = 0., GOODUU (2, 1, 1) = 0., GOODUU (3, 1, 1) = 0., GOODUU (4, 1, 1) = 3.47678E-01,
                      GOODUU (5, 1, 1) = 4.87120E-02, GOODUU (6, 1, 1) = 1.89387E-02, GOODUU (1, 2, 1) = 1.86027E-02,
                      GOODUU (2, 2, 1) = 4.64061E-02, GOODUU (3, 2, 1) = 6.77603E-02, GOODUU (4, 2, 1) = 0., GOODUU (5, 2, 1) = 0.,
                      GOODUU (6, 2, 1) = 0.;
        break;
      case 3:
        /* Correct answers */
        ...
        GOODUU (1, 1, 1) = 0., GOODUU (2, 1, 1) = 0., GOODUU (3, 1, 1) = 0., GOODUU (4, 1, 1) = 1.62566E-01,
                      GOODUU (5, 1, 1) = 2.45786E-02, GOODUU (6, 1, 1) = 1.01498E-02, GOODUU (1, 2, 1) = 1.70004E-04,
                      GOODUU (2, 2, 1) = 3.97168E-05, GOODUU (3, 2, 1) = 1.32472E-05, GOODUU (4, 2, 1) = 0., GOODUU (5, 2, 1) = 0.,
                      GOODUU (6, 2, 1) = 0.;
        break;
      case 4:
        /* Correct answers */
        ...
        good.rad[0].dfdt = 0., good.rad[1].dfdt = 0.;
        GOODUU (1, 1, 1) = 0., GOODUU (2, 1, 1) = 0., GOODUU (3, 1, 1) = 0., GOODUU (4, 1, 1) = 3.64010E-01,
                      GOODUU (5, 1, 1) = 8.26993E-02, GOODUU (6, 1, 1) = 4.92370E-02, GOODUU (1, 2, 1) = 1.05950E-02,
                      GOODUU (2, 2, 1) = 7.69337E-03, GOODUU (3, 2, 1) = 3.79276E-03, GOODUU (4, 2, 1) = 0., GOODUU (5, 2, 1) = 0.,
                      GOODUU (6, 2, 1) = 0.;
        break;
      }

      sprintf (ds.header,
               "Test Case No. 2%.1s, Rayleigh Scattering, Ref. SW, Table 1:  tau =%5.2f, mu0 =%9.6f, ss-albedo =%4.2f",
               abc + icas - 1,
               UTAU (2),
               ds.bc.umu0,
               SSALB (1));
...
void disort_test03 (void) {
  ...
  for (icas = 1; icas <= ncase; icas++) {
    ...
    case 1:
      ...
      good.rad[0].dfdt = 0., good.rad[1].dfdt = 0.;
      GOODUU (1, 1, 1) = 0., GOODUU (2, 1, 1) = 0., GOODUU (3, 1, 1) = 0., GOODUU (4, 1, 1) = 1.51159E-01,
                    GOODUU (5, 1, 1) = 1.01103E-01, GOODUU (6, 1, 1) = 3.95460E-02, GOODUU (1, 2, 1) = 3.05855E+00,
                    GOODUU (2, 2, 1) = 2.66648E-01, GOODUU (3, 2, 1) = 2.13750E-01, GOODUU (4, 2, 1) = 0., GOODUU (5, 2, 1) = 0.,
                    GOODUU (6, 2, 1) = 0.;
      break;
    case 2:
      UTAU (2) = 8.0;
      ...
      good.rad[0].dfdt = 0., good.rad[1].dfdt = 0.;
      GOODUU (1, 1, 1) = 0., GOODUU (2, 1, 1) = 0., GOODUU (3, 1, 1) = 0., GOODUU (4, 1, 1) = 3.79740E-01,
                    GOODUU (5, 1, 1) = 5.19598E-01, GOODUU (6, 1, 1) = 4.93302E-01, GOODUU (1, 2, 1) = 6.69581E-01,
                    GOODUU (2, 2, 1) = 4.22350E-01, GOODUU (3, 2, 1) = 2.36362E-01, GOODUU (4, 2, 1) = 0., GOODUU (5, 2, 1) = 0.,
                    GOODUU (6, 2, 1) = 0.;
      break;
    }
    ...
    sprintf (ds.header,
             "Test Case No. 3%.1s, Henyey-Greenstein Scattering, Ref. VH2, Table 37, g = %3.2f, b =%9.5f, a =%5.2f",
             abc + icas - 1,
             gg,
             UTAU (2),
             SSALB (1));
...
void disort_test04 (void) {
  const int     ncase = 3;
  char          title[128], abc[] = "abcdefghijklmnopqrstuvwxyz";
  disort_state  ds;
  disort_output out, good;
  register int  icas;
  ...
  for (icas = 1; icas <= ncase; icas++) {
    ...
    case 1:
      ...
      GOODUU (1, 1, 1) = 0., GOODUU (2, 1, 1) = 0., GOODUU (3, 1, 1) = 0., GOODUU (4, 1, 1) = 9.26837E-02,
                    GOODUU (5, 1, 1) = 6.59569E-02, GOODUU (6, 1, 1) = 3.64755E-02, GOODUU (1, 2, 1) = 2.51608E+00,
                    GOODUU (2, 2, 1) = 1.19287E-01, GOODUU (3, 2, 1) = 1.34962E-01, GOODUU (4, 2, 1) = 1.23887E-01,
                    GOODUU (5, 2, 1) = 4.02058E-02, GOODUU (6, 2, 1) = 1.77746E-02, GOODUU (1, 3, 1) = 3.37302E+00,
                    GOODUU (2, 3, 1) = 2.19835E-01, GOODUU (3, 3, 1) = 1.56893E-01, GOODUU (4, 3, 1) = 0., GOODUU (5, 3, 1) = 0.,
                    GOODUU (6, 3, 1) = 0.;
      break;
    case 2:
      ds.nphi = 1;
      ...
      GOODUU (1, 1, 1) = 0., GOODUU (2, 1, 1) = 0., GOODUU (3, 1, 1) = 0., GOODUU (4, 1, 1) = 6.53056E-02,
                    GOODUU (5, 1, 1) = 4.55144E-02, GOODUU (6, 1, 1) = 2.82693E-02, GOODUU (1, 2, 1) = 2.24258E+00,
                    GOODUU (2, 2, 1) = 9.66049E-02, GOODUU (3, 2, 1) = 9.61335E-02, GOODUU (4, 2, 1) = 8.43278E-02,
                    GOODUU (5, 2, 1) = 2.79473E-02, GOODUU (6, 2, 1) = 1.38835E-02, GOODUU (1, 3, 1) = 2.97057E+00,
                    GOODUU (2, 3, 1) = 1.67698E-01, GOODUU (3, 3, 1) = 1.08115E-01, GOODUU (4, 3, 1) = 0., GOODUU (5, 3, 1) = 0.,
                    GOODUU (6, 3, 1) = 0.;
      break;
    case 3:
      ds.nphi = 3;
      ...
      GOODUU (1, 1, 1) = 0., GOODUU (2, 1, 1) = 0., GOODUU (3, 1, 1) = 0., GOODUU (4, 1, 1) = 8.70812E-01,
                    GOODUU (5, 1, 1) = 2.24960E-01, GOODUU (6, 1, 1) = 2.27572E-02, GOODUU (1, 2, 1) = 4.77016E-02,
                    GOODUU (2, 2, 1) = 3.02631E+00, GOODUU (3, 2, 1) = 1.41195E+00, GOODUU (4, 2, 1) = 6.97692E-01,
                    GOODUU (5, 2, 1) = 1.09130E-01, GOODUU (6, 2, 1) = 9.32861E-03, GOODUU (1, 3, 1) = 8.38488E-02,
                    GOODUU (2, 3, 1) = 2.70538E+00, GOODUU (3, 3, 1) = 8.76523E-01, GOODUU (4, 3, 1) = 0., GOODUU (5, 3, 1) = 0.,
                    GOODUU (6, 3, 1) = 0., GOODUU (1, 1, 2) = 0., GOODUU (2, 1, 2) = 0., GOODUU (3, 1, 2) = 0.,
                    GOODUU (4, 1, 2) = 8.88117E-02, GOODUU (5, 1, 2) = 5.77411E-02, GOODUU (6, 1, 2) = 2.27572E-02,
                    GOODUU (1, 2, 2) = 4.77016E-02, GOODUU (2, 2, 2) = 5.80971E-02, GOODUU (3, 2, 2) = 1.04502E-01,
                    GOODUU (4, 2, 2) = 9.16071E-02, GOODUU (5, 2, 2) = 2.95842E-02, GOODUU (6, 2, 2) = 9.32861E-03,
                    GOODUU (1, 3, 2) = 8.38488E-02, GOODUU (2, 3, 2) = 9.42187E-02, GOODUU (3, 3, 2) = 8.95457E-02,
                    GOODUU (4, 3, 2) = 0., GOODUU (5, 3, 2) = 0., GOODUU (6, 3, 2) = 0., GOODUU (1, 1, 3) = 0.,
                    GOODUU (2, 1, 3) = 0., GOODUU (3, 1, 3) = 0., GOODUU (4, 1, 3) = 6.98247E-02, GOODUU (5, 1, 3) = 5.02877E-02,
                    GOODUU (6, 1, 3) = 2.27572E-02, GOODUU (1, 2, 3) = 4.77016E-02, GOODUU (2, 2, 3) = 2.58544E-02,
                    GOODUU (3, 2, 3) = 6.25954E-02, GOODUU (4, 2, 3) = 5.91273E-02, GOODUU (5, 2, 3) = 2.47702E-02,
                    GOODUU (6, 2, 3) = 9.32861E-03, GOODUU (1, 3, 3) = 8.38488E-02, GOODUU (2, 3, 3) = 3.99383E-02,
                    GOODUU (3, 3, 3) = 4.67155E-02, GOODUU (4, 3, 3) = 0., GOODUU (5, 3, 3) = 0., GOODUU (6, 3, 3) = 0.;
      break;
    }
...
void disort_test05 (void) {
  ...
  for (icas = 1; icas <= ncase; icas++) {
    ...
    case 1:
      ...
      good.rad[0].dfdt = 0., good.rad[1].dfdt = 0., good.rad[2].dfdt = 0.;
      GOODUU (1, 1, 1) = 0., GOODUU (2, 1, 1) = 0., GOODUU (3, 1, 1) = 0., GOODUU (4, 1, 1) = 4.58927E-01,
                    GOODUU (5, 1, 1) = 7.72983E-01, GOODUU (6, 1, 1) = 1.07196E+00, GOODUU (1, 2, 1) = 7.53662E-01,
                    GOODUU (2, 2, 1) = 6.96362E-01, GOODUU (3, 2, 1) = 6.50541E-01, GOODUU (4, 2, 1) = 6.27631E-01,
                    GOODUU (5, 2, 1) = 5.81809E-01, GOODUU (6, 2, 1) = 5.24532E-01, GOODUU (1, 3, 1) = 1.95230E-01,
                    GOODUU (2, 3, 1) = 1.31990E-01, GOODUU (3, 3, 1) = 7.20655E-02, GOODUU (4, 3, 1) = 0., GOODUU (5, 3, 1) = 0.,
                    GOODUU (6, 3, 1) = 0.;
      break;
    case 2:
      UTAU (1)  = 3.2;
      ...
      GOODUU (1, 1, 1) = 6.79623E+01, GOODUU (2, 1, 1) = 2.21027E-01, GOODUU (3, 1, 1) = 1.36619E-01,
                    GOODUU (4, 1, 1) = 1.14084E-01, GOODUU (5, 1, 1) = 8.73870E-02, GOODUU (6, 1, 1) = 8.81626E-02,
                    GOODUU (1, 2, 1) = 2.05706E-01, GOODUU (2, 2, 1) = 4.92736E-02, GOODUU (3, 2, 1) = 2.65449E-02,
                    GOODUU (4, 2, 1) = 2.02154E-02, GOODUU (5, 2, 1) = 1.29661E-02, GOODUU (6, 2, 1) = 9.51334E-03,
                    GOODUU (1, 3, 1) = 3.41286E-05, GOODUU (2, 3, 1) = 1.39916E-05, GOODUU (3, 3, 1) = 7.47039E-06,
                    GOODUU (4, 3, 1) = 5.65602E-06, GOODUU (5, 3, 1) = 3.58245E-06, GOODUU (6, 3, 1) = 2.57858E-06;
      break;
      break;
    }
...
void disort_test06 (void) {
  ...
  for (icas = 1; icas <= ncase; icas++) {
    ...
    case 1:
      ...
      /* Correct answers */
      good.rad[0].rfldir = 100., good.rad[1].rfldir = 100., good.rad[0].rfldn = 0., good.rad[1].rfldn = 0., good.rad[0].flup = 0.,
      good.rad[1].flup = 0., good.rad[0].dfdt = 200., good.rad[1].dfdt = 200., GOODUU (1, 1, 1) = 0., GOODUU (2, 1, 1) = 0.,
      GOODUU (3, 1, 1) = 0., GOODUU (4, 1, 1) = 0., GOODUU (1, 2, 1) = 0., GOODUU (2, 2, 1) = 0., GOODUU (3, 2, 1) = 0.,
      GOODUU (4, 2, 1) = 0.;
      break;
    case 2:
      /*
      ...
      GOODUU (1, 1, 1) = 0., GOODUU (2, 1, 1) = 0., GOODUU (3, 1, 1) = 0., GOODUU (4, 1, 1) = 0., GOODUU (1, 2, 1) = 0.,
                    GOODUU (2, 2, 1) = 0., GOODUU (3, 2, 1) = 0., GOODUU (4, 2, 1) = 0., GOODUU (1, 3, 1) = 0.,
                    GOODUU (2, 3, 1) = 0., GOODUU (3, 3, 1) = 0., GOODUU (4, 3, 1) = 0.;
      break;
    case 3:
      /*
    ...
    case 6:
      ...
      GOODUU (1, 1, 1) = 1.02336E+02, GOODUU (2, 1, 1) = 1.02336E+02, GOODUU (3, 1, 1) = 4.80531E-03,
                    GOODUU (4, 1, 1) = 4.50168E+01, GOODUU (1, 2, 1) = 6.20697E+01, GOODUU (2, 2, 1) = 6.89532E-01,
                    GOODUU (3, 2, 1) = 7.13172E-01, GOODUU (4, 2, 1) = 7.42191E+01, GOODUU (1, 3, 1) = 3.76472E+01,
                    GOODUU (2, 3, 1) = 4.64603E-03, GOODUU (3, 3, 1) = 1.05844E+02, GOODUU (4, 3, 1) = 1.22368E+02;
      break;
    case 7:
      /*
      ...
      GOODUU (1, 1, 1) = 1.02336E+02, GOODUU (2, 1, 1) = 1.02336E+02, GOODUU (3, 1, 1) = 7.80733E+01,
                    GOODUU (4, 1, 1) = 1.16430E+02, GOODUU (1, 2, 1) = 9.78748E+01, GOODUU (2, 2, 1) = 1.01048E+02,
                    GOODUU (3, 2, 1) = 1.15819E+02, GOODUU (4, 2, 1) = 1.34966E+02, GOODUU (1, 3, 1) = 1.10061E+02,
                    GOODUU (2, 3, 1) = 1.38631E+02, GOODUU (3, 3, 1) = 1.38695E+02, GOODUU (4, 3, 1) = 1.40974E+02;
      break;
    case 8:
      /*
      ...
      GOODUU (1, 1, 1) = 1.02336E+02, GOODUU (2, 1, 1) = 1.02336E+02, GOODUU (3, 1, 1) = 7.12616E+01,
                    GOODUU (4, 1, 1) = 7.80736E+01, GOODUU (1, 2, 1) = 8.49992E+01, GOODUU (2, 2, 1) = 7.73186E+01,
                    GOODUU (3, 2, 1) = 7.88310E+01, GOODUU (4, 2, 1) = 8.56423E+01, GOODUU (1, 3, 1) = 1.38631E+02,
                    GOODUU (2, 3, 1) = 1.45441E+02, GOODUU (3, 3, 1) = 1.44792E+02, GOODUU (4, 3, 1) = 1.45163E+02;
      break;
    }
...
void disort_test07 (void) {
  ...
  for (icas = 1; icas <= ncase; icas++) {
    ...
    case 1:
      ...
      /* Correct answers */
      good.rad[0].rfldir = 0., good.rad[1].rfldir = 0., good.rad[0].rfldn = 0., good.rad[1].rfldn = 1.21204E+02,
      good.rad[0].flup = 8.62936E+01, good.rad[1].flup = 0., good.rad[0].dfdt = -5.13731E+01, good.rad[1].dfdt = -5.41036E+02;
      break;
    case 2:
      ds.flag.ibcnd  = GENERAL_BC;
      ds.flag.usrang = TRUE;
      ...
      /* Correct answers */
      good.rad[0].rfldir = 0., good.rad[1].rfldir = 0., good.rad[0].rfldn = 0., good.rad[1].rfldn = 2.07786E-05,
      good.rad[0].flup = 1.10949E-06, good.rad[1].flup = 0., good.rad[0].dfdt = 8.23219E-08, good.rad[1].dfdt = -5.06461E-06,
      GOODUU (1, 1, 1) = 0., GOODUU (2, 1, 1) = 4.65744E-07, GOODUU (1, 2, 1) = 7.52311E-06, GOODUU (2, 2, 1) = 0.;
      break;
    case 3:
      ds.flag.ibcnd                    = GENERAL_BC;
      ds.flag.usrang                   = TRUE;
      ...
      GOODUU (1, 1, 1) = 1.01805E+02, GOODUU (2, 1, 1) = 1.01805E+02, GOODUU (3, 1, 1) = 1.46775E+02,
                    GOODUU (4, 1, 1) = 1.49033E+02, GOODUU (1, 2, 1) = 1.06583E+02, GOODUU (2, 2, 1) = 1.28565E+02,
                    GOODUU (3, 2, 1) = 1.04464E+02, GOODUU (4, 2, 1) = 1.59054E+02, GOODUU (1, 3, 1) = 9.66519E+01,
                    GOODUU (2, 3, 1) = 8.65854E+01, GOODUU (3, 3, 1) = 1.89259E+02, GOODUU (4, 3, 1) = 1.89259E+02,
                    GOODUU (1, 1, 2) = 1.01805E+02, GOODUU (2, 1, 2) = 1.01805E+02, GOODUU (3, 1, 2) = 1.29641E+02,
                    GOODUU (4, 1, 2) = 1.49033E+02, GOODUU (1, 2, 2) = 1.06583E+02, GOODUU (2, 2, 2) = 1.06408E+02,
                    GOODUU (3, 2, 2) = 9.48418E+01, GOODUU (4, 2, 2) = 1.59054E+02, GOODUU (1, 3, 2) = 9.66519E+01,
                    GOODUU (2, 3, 2) = 7.49310E+01, GOODUU (3, 3, 2) = 1.89259E+02, GOODUU (4, 3, 2) = 1.89259E+02;
      break;
    case 4:
      ds.flag.lamber = TRUE;
      ds.flag.ibcnd  = GENERAL_BC;
      ...
      GOODUU (1, 1, 1) = 1.01805E+02, GOODUU (2, 1, 1) = 1.01805E+02, GOODUU (3, 1, 1) = 1.40977E+02,
                    GOODUU (4, 1, 1) = 9.62764E+01, GOODUU (1, 2, 1) = 1.06203E+02, GOODUU (2, 2, 1) = 1.23126E+02,
                    GOODUU (3, 2, 1) = 9.19545E+01, GOODUU (4, 2, 1) = 8.89528E+01, GOODUU (1, 3, 1) = 9.56010E+01,
                    GOODUU (2, 3, 1) = 7.25576E+01, GOODUU (3, 3, 1) = 9.72743E+01, GOODUU (4, 3, 1) = 9.72743E+01,
                    GOODUU (1, 1, 2) = 1.01805E+02, GOODUU (2, 1, 2) = 1.01805E+02, GOODUU (3, 1, 2) = 1.23843E+02,
                    GOODUU (4, 1, 2) = 9.62764E+01, GOODUU (1, 2, 2) = 1.06203E+02, GOODUU (2, 2, 2) = 1.00969E+02,
                    GOODUU (3, 2, 2) = 8.23318E+01, GOODUU (4, 2, 2) = 8.89528E+01, GOODUU (1, 3, 2) = 9.56010E+01,
                    GOODUU (2, 3, 2) = 6.09031E+01, GOODUU (3, 3, 2) = 9.72743E+01, GOODUU (4, 3, 2) = 9.72743E+01;
      break;
    case 5:
      ds.flag.ibcnd  = GENERAL_BC;
      ds.flag.lamber = FALSE;
      ...
      GOODUU (1, 1, 1) = 1.01805E+02, GOODUU (2, 1, 1) = 1.01805E+02, GOODUU (3, 1, 1) = 1.45448E+02,
                    GOODUU (4, 1, 1) = 1.38554E+02, GOODUU (1, 2, 1) = 1.06496E+02, GOODUU (2, 2, 1) = 1.27296E+02,
                    GOODUU (3, 2, 1) = 1.01395E+02, GOODUU (4, 2, 1) = 1.45229E+02, GOODUU (1, 3, 1) = 9.63993E+01,
                    GOODUU (2, 3, 1) = 8.29009E+01, GOODUU (3, 3, 1) = 1.60734E+02, GOODUU (4, 3, 1) = 1.71307E+02,
                    GOODUU (1, 1, 2) = 1.01805E+02, GOODUU (2, 1, 2) = 1.01805E+02, GOODUU (3, 1, 2) = 1.28281E+02,
                    GOODUU (4, 1, 2) = 1.38554E+02, GOODUU (1, 2, 2) = 1.06496E+02, GOODUU (2, 2, 2) = 1.05111E+02,
                    GOODUU (3, 2, 2) = 9.16726E+01, GOODUU (4, 2, 2) = 1.45229E+02, GOODUU (1, 3, 2) = 9.63993E+01,
                    GOODUU (2, 3, 2) = 7.11248E+01, GOODUU (3, 3, 2) = 1.59286E+02, GOODUU (4, 3, 2) = 1.71307E+02;
      break;
    }
...
void disort_test08 (void) {
  ...
  for (icas = 1; icas <= ncase; icas++) {
    ...
    case 1:
      ...
      GOODUU (1, 1, 1) = 3.18310E-01, GOODUU (2, 1, 1) = 3.18310E-01, GOODUU (3, 1, 1) = 5.62566E-02,
                    GOODUU (4, 1, 1) = 1.94423E-02, GOODUU (1, 2, 1) = 2.62711E-01, GOODUU (2, 2, 1) = 1.36952E-01,
                    GOODUU (3, 2, 1) = 1.84909E-02, GOODUU (4, 2, 1) = 5.52188E-03, GOODUU (1, 3, 1) = 2.10014E-01,
                    GOODUU (2, 3, 1) = 5.60376E-02, GOODUU (3, 3, 1) = 0., GOODUU (4, 3, 1) = 0.;
      break;
    case 2:
      DTAUC (1) = .25;
      DTAUC (2) = .25;
      ...
      GOODUU (1, 1, 1) = 3.18310E-01, GOODUU (2, 1, 1) = 3.18310E-01, GOODUU (3, 1, 1) = 1.23687E-01,
                    GOODUU (4, 1, 1) = 4.95581E-02, GOODUU (1, 2, 1) = 2.77499E-01, GOODUU (2, 2, 1) = 1.83950E-01,
                    GOODUU (3, 2, 1) = 8.35695E-02, GOODUU (4, 2, 1) = 2.50575E-02, GOODUU (1, 3, 1) = 2.40731E-01,
                    GOODUU (2, 3, 1) = 1.29291E-01, GOODUU (3, 3, 1) = 0., GOODUU (4, 3, 1) = 0.;
      break;
    case 3:
      DTAUC (1) = 1.;
      DTAUC (2) = 2.;
      ...
      GOODUU (1, 1, 1) = 3.18310E-01, GOODUU (2, 1, 1) = 3.18310E-01, GOODUU (3, 1, 1) = 1.49335E-01,
                    GOODUU (4, 1, 1) = 1.04766E-01, GOODUU (1, 2, 1) = 1.89020E-01, GOODUU (2, 2, 1) = 9.88158E-02,
                    GOODUU (3, 2, 1) = 9.65192E-02, GOODUU (4, 2, 1) = 6.54445E-02, GOODUU (1, 3, 1) = 6.84762E-02,
                    GOODUU (2, 3, 1) = 2.96698E-02, GOODUU (3, 3, 1) = 0., GOODUU (4, 3, 1) = 0.;
      break;
    }
...
void disort_test09 (void) {
  ...
  for (icas = 1; icas <= ncase; icas++) {
    ...
    case 1:
      ...
      good.rad[0].rfldn = 1., good.rad[1].rfldn = 3.55151E-01, good.rad[2].rfldn = 1.44265E-01, good.rad[3].rfldn = 6.71445E-03,
      good.rad[4].rfldn = 6.16968E-07;
      good.rad[0].flup = 2.27973E-01, good.rad[1].flup = 8.75098E-02, good.rad[2].flup = 3.61819E-02,
      good.rad[3].flup = 2.19291E-03, good.rad[4].flup = 0.;
      good.rad[0].dfdt = 8.82116E-01, good.rad[1].dfdt = 2.32366E-01, good.rad[2].dfdt = 9.33443E-02,
      good.rad[3].dfdt = 3.92782E-03, good.rad[4].dfdt = 1.02500E-07;
      GOODUU (1, 1, 1) = 3.18310E-01, GOODUU (2, 1, 1) = 3.18310E-01, GOODUU (3, 1, 1) = 9.98915E-02,
                    GOODUU (4, 1, 1) = 5.91345E-02, GOODUU (1, 2, 1) = 1.53507E-01, GOODUU (2, 2, 1) = 5.09531E-02,
                    GOODUU (3, 2, 1) = 3.67006E-02, GOODUU (4, 2, 1) = 2.31903E-02, GOODUU (1, 3, 1) = 7.06614E-02,
                    GOODUU (2, 3, 1) = 2.09119E-02, GOODUU (3, 3, 1) = 1.48545E-02, GOODUU (4, 3, 1) = 9.72307E-03,
                    GOODUU (1, 4, 1) = 3.72784E-03, GOODUU (2, 4, 1) = 1.08815E-03, GOODUU (3, 4, 1) = 8.83316E-04,
                    GOODUU (4, 4, 1) = 5.94743E-04, GOODUU (1, 5, 1) = 2.87656E-07, GOODUU (2, 5, 1) = 1.05921E-07,
                    GOODUU (3, 5, 1) = 0., GOODUU (4, 5, 1) = 0.;
      break;
    case 2:
      /* Allocate memory */
      c_disort_state_alloc (&ds);
      ...
      /* Correct answers */
      good.rad[0].rfldir = 0., good.rad[1].rfldir = 0., good.rad[2].rfldir = 0., good.rad[3].rfldir = 0., good.rad[4].rfldir = 0.;
      good.rad[0].rfldn = 1., good.rad[1].rfldn = 4.52357E-01, good.rad[2].rfldn = 2.36473E-01, good.rad[3].rfldn = 2.76475E-02,
      good.rad[4].rfldn = 7.41853E-05;
      good.rad[0].flup = 1.00079E-01, good.rad[1].flup = 4.52014E-02, good.rad[2].flup = 2.41941E-02,
      good.rad[3].flup = 4.16016E-03, good.rad[4].flup = 0.;
      good.rad[0].dfdt = 8.04577E-01, good.rad[1].dfdt = 2.55330E-01, good.rad[2].dfdt = 1.30976E-01,
      good.rad[3].dfdt = 1.36227E-02, good.rad[4].dfdt = 1.22022E-05;
      GOODUU (1, 1, 1) = 3.18310E-01, GOODUU (2, 1, 1) = 3.18310E-01, GOODUU (3, 1, 1) = 7.39198E-02,
                    GOODUU (4, 1, 1) = 1.32768E-02, GOODUU (1, 2, 1) = 1.96609E-01, GOODUU (2, 2, 1) = 5.92369E-02,
                    GOODUU (3, 2, 1) = 3.00230E-02, GOODUU (4, 2, 1) = 7.05566E-03, GOODUU (1, 3, 1) = 1.15478E-01,
                    GOODUU (2, 3, 1) = 3.01809E-02, GOODUU (3, 3, 1) = 1.52672E-02, GOODUU (4, 3, 1) = 4.06932E-03,
                    GOODUU (1, 4, 1) = 1.46177E-02, GOODUU (2, 4, 1) = 3.85590E-03, GOODUU (3, 4, 1) = 2.38301E-03,
                    GOODUU (4, 4, 1) = 7.77890E-04, GOODUU (1, 5, 1) = 3.37742E-05, GOODUU (2, 5, 1) = 1.20858E-05,
                    GOODUU (3, 5, 1) = 0., GOODUU (4, 5, 1) = 0.;
      break;
    case 3:
      ds.flag.planck = TRUE;
      ...
      /* Correct answers */
      good.rad[0].rfldir = 1.57080E+00, good.rad[1].rfldir = 1.92354E-01, good.rad[2].rfldir = 2.35550E-02;
      good.rad[3].rfldir = 9.65131E-06, good.rad[4].rfldir = 9.03133E-19;
      good.rad[0].rfldn = 6.09217E+00, good.rad[1].rfldn = 4.97279E+00, good.rad[2].rfldn = 4.46616E+00;
      good.rad[3].rfldn = 4.22731E+00, good.rad[4].rfldn = 4.73767E+00;
      good.rad[0].flup = 4.68414E+00, good.rad[1].flup = 4.24381E+00, good.rad[2].flup = 4.16941E+00;
      good.rad[3].flup = 4.30667E+00, good.rad[4].flup = 5.11524E+00;
      good.rad[0].dfdt = 3.49563E+00, good.rad[1].dfdt = 8.81206E-01, good.rad[2].dfdt = 3.50053E-01;
      good.rad[3].dfdt = 1.93471E-02, good.rad[4].dfdt = 7.15349E-02;
...
void disort_test10 (void) {
  register int  lc;
  double        gg;
  disort_state  ds_good, ds_out;
  disort_output good, out;
...
void disort_test14 (void) {
  register int  lc;
  double        radius, *gg;
  int           deltam, ierror[TWOSTR_NERR];
  disort_state  ds_ds, twostr_ds;
  ...
  if (twostr_ds.flag.spher)
    twostr_ds.zd[0] = 10. * (double)(twostr_ds.nlyr + 1);
  for (lc = 1; lc <= twostr_ds.nlyr; lc++) {
    ...
    if (twostr_ds.flag.spher)
      twostr_ds.zd[lc] = 10. * (double)(twostr_ds.nlyr - lc + 1);
  }
...
void print_test (disort_state* ds_calc, disort_output* calc, disort_state* ds_good, disort_output* good) {
  register int  iu, j, lu, numbad;
  extern void   c_errmsg();
  extern double c_ratio();
  double        flxmax, umax, fnoise, unoise, rat1, rat2, rat3, rat4, ratv[ds_good->nphi];
  ...
  for (lu = 1; lu <= ds_good->ntau; lu++) {
    fprintf (stdout,
             "%11.4f%15.4e%15.4e%15.4e%15.4e\n",
             UTAU (lu),
             calc->rad[lu - 1].rfldir,
             calc->rad[lu - 1].rfldn,
             calc->rad[lu - 1].flup,
             calc->rad[lu - 1].dfdt);
